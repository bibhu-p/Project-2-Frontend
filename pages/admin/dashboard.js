...
const AdminDashboard = () => {
    ...
    return ( 
        <div className="flex  flex-col justify-start h-[95vh] w-[75vw]">
            <div className=" bg-white rounded-lg p-4 w-[100%] sm:w-[85%] h-fit  m-4  shadow-md">
            ...
            <div className=" bg-white rounded-lg p-3 w-[18rem]  m-4 mt-10 shadow-md">
                <div className="border-b pb-2 flex flex-row justify-between">
                    <span className="text-xl">Users Info</span>
                </div>
                    <div className="grid grid-cols-2 gap-2">
                        <div className="rounded col-span-1 my-4">
                            <div className="">No of Users : {usersInfo.length}</div>
                        </div>
                    </div>
            </div>
